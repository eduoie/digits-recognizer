"""Obtained from https://github.com/cereniyim/Wine-Rating-Predictor-ML-Model/blob/master/orchestrator/util.py
Originally from https://github.com/datarevenue-berlin/code-challenge-2020/blob/master/orchestrator/util.py
"""
import os
...
# }
CONTAINER_TASK_VOLUMES = {}
CONTAINER_TASK_NET = os.getenv('ORCHESTRATOR_NETWORK')
